...
export { default as AcademicsPage } from './AcademicsPage/AcademicsPage'
export { default as ActivitiesPage } from './ActivitiesPage/ActivitiesPage'
export { default as ContactPage } from './ContactPage/ContactPage'
export { default as PlacementsPage } from './PlacementsPage/PlacementsPage'
...
export { default as ClubsPage } from './Admin/ClubsPage/ClubsPage'
export { default as FacilitiesAdmin } from './Admin/FacilitiesAdmin/FacilitiesAdmin'
